# smartbite
SmartBite is a full-stack application built with FastAPI, Flutter, and PostgreSQL to reduce food waste by enabling real-time sale of near-expiry supermarket products.
