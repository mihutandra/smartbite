...
class SupermarketProduct(Base):
    ...
    supermarket_id = Column(UUID(as_uuid=True), ForeignKey("supermarkets.id", ondelete="CASCADE"), nullable=False)
    ...
    __table_args__ = (
        UniqueConstraint("supermarket_id", "product_id", name="uq_supermarket_product"),
    )
