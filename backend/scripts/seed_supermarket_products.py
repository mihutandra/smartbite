...
PRODUCT_NAMES = [
    "Pâine neagră tradițională",
    "Brânză de burduf",
    "Lapte integral pasteurizat",
    "Smântână de vaci",
    "Cărnuri procesate - Șunca de casă",
    "Miere de albine sălbatică",
    "Brânzetură moale tradițională",
    "Gem de coacăze negre",
    "Iaurt natural cu cultură de bacterii vii",
    "Ouă de găini crescute în curte",
    "Ulei de floarea soarelui presat la rece",
    "Morcovi freschi biologici",
]
